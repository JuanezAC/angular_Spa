...
export class AdminProfesionalesCrear implements OnInit {
  ...
  profesionalNuevo: Profesional = { nombre: '', especialidad: '', correo: '', telefono: '', activo: true };
    ...
    try {
      ...
      const creado = await firstValueFrom(
        this.profesionalService.crear({
          nombre, especialidad, correo, telefono, activo: this.profesionalNuevo.activo
        })
  ...
  limpiarFormulario(): void {
    this.profesionalNuevo = { nombre: '', especialidad: '', correo: '', telefono: '', activo: true };
