...
export class AdminCitas {
  //trae desde el backend
  private citaService = inject(CitaService);
  //redirige a otra pagina
  private router = inject(Router);
  //fuerza actualizaciones cuando es detectado un cambio
  private cdr = inject(ChangeDetectorRef);

  //Guarda el estado 
  estado$: Observable<CitaState>;
  //Es donde se escribe que se filtra
  textoFiltro: string = '';

  //Carga las citas automaticamente
  constructor() { this.estado$ = this.cargarCitas(); }
